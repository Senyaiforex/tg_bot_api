...
class TextAdminData:
    ...
    task_description: str = "Введите описание задание"
    ...
    pull_input_success: str = ("Установлен новый пулл на {key}.\n"
                               "Размер - {size}.\n"
                               "*Теперь введите пулл на {next_key}*")
    pull_new_success: str = ("Пулл на монеты - _\r{size}_\r\n"
                             "Фарминг - _\r{farming}_\r\n"
                             "Друзья - _\r{friends}_\r\n"
                             "Задания - _\r{task}_\r\n"
                             "Краудсорсинг - _\r{plan}_\r\n"
                             "Вы хотите установить новый пулл с вышеуказанными значениями?")
    pull_empty: str = ("Пожалуйста, введите правильный пулл для всех остальных"
...
class TextUserData:
    ...
    photo_cancell = ("Размер фотографии не должен превышать 3 МБ!\n"
