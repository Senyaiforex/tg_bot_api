...
class TextAdminData:
    ...
    text_liquid: str = ("*Пул ликвидности*\n\n"
                        "Постов бесплатно - _\r{need_free}_\r.  На данный момент - _\r{current_free}_\r\n"
                        "Постов за монеты - _\r{need_coins}_\r.  На данный момент - _\r{current_coins}_\r\n"
                        "Постов за токены - _\r{need_token}_\r.  На данный момент - _\r{current_token}_\r\n"
                        "Постов за рубли - _\r{need_money}_\r.  На данный момент - _\r{current_money}_\r\n"
                        "Постов за звёзды - _\r{need_stars}_\r.  На данный момент - _\r{current_stars}_\r")
...
class TextUserData:
    ...
    name_product: str = ("Введите название товара\n\n"
                         "От 5 до 75 символов, без эмоджи-смайлов и специальных символов")
